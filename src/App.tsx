    ...
    <AppContext>
      <Router>
        <Routes>
          ...
          />
          <Route
            path="/solution/team/register"
            element={<Page.TeamRegister />}
          />
          <Route
            path="/solution/team/teachers"
            element={<Page.TeamTeachers />}
          />
          <Route
          ...
          />
          <Route
            path="/solution/team/business"
            element={<Page.TeamBusiness />}
          />
          ...
          />
          <Route
            path="/solution/features/apps"
            element={<Page.FeatureApps />}
          />
          <Route
          ...
          <Route path="/roi" element={<Page.ROICalc />} />
